function [max_rel_error_moles, max_rel_error_prop] = run_test_HP_CEA_2(value)
    % Run test_HP_CEA_1:
    ...
    max_rel_error_prop = compute_error_prop_CEA(results_CT, results_CEA, {'phi', 'phi', 'phi', 'phi', 'phi', 'phi', 'phi', 'phi', 'phi'}, value, {'T', 'rho', 'h', 'e', 'g', 'S', 'cP', 'cV', 'gamma_s'}, 'mix2');
end