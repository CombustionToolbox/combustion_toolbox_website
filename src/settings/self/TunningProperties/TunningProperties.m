function self = TunningProperties()
    ...
    %     tolN (float):           Tolerance of the Gibbs minimization method                        (default: 1e-15)
    ...
    %     root_T0_l (float):      First guess T [K] left branch - root finding method               (default: 300)
    %     root_T0_r (float):      First guess T [K] right branch - root finding method              (default: 1500)
    %     root_T0 (float):        Guess T[K] if it's of previous range - root finding method        (default: 2000)
