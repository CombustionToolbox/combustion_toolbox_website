...
The {mat:class}`~src.+combustiontoolbox.+utils.+display.@Canvas.Canvas` superclass manages figure creation and plotting layout configuration 

:::{dropdown} Routines
```{eval-rst}
.. automodule:: src.+combustiontoolbox.+utils.+display.@Canvas
   :show-inheritance:
   :members:
```
:::
...
:::{dropdown} Routines
```{eval-rst}
.. automodule:: src.+combustiontoolbox.+utils.+display.@PlotFigure
   :show-inheritance:
   :members:
```
:::
...
:::{dropdown} Routines
```{eval-rst}
.. automodule:: src.+combustiontoolbox.+utils.+display.@PlotComposition
   :show-inheritance:
   :members:
```
:::
...
:::{dropdown} Routines
```{eval-rst}
.. automodule:: src.+combustiontoolbox.+utils.@Benchmark
   :show-inheritance:
   :members:
```
:::
...
:::{dropdown} Routines
```{eval-rst}
.. automodule:: src.+combustiontoolbox.+utils.@BenchmarkMetadata
   :show-inheritance:
   :members:
```
:::
