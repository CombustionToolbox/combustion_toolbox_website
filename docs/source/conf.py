...
html_theme_options = {
    "announcement": '<a class="no-underline"; href="https://www.researchgate.net/publication/398856092_Combustion_Toolbox_An_open-source_thermochemical_code_for_gas-_and_condensed-phase_problems_involving_chemical_equilibrium"; target="_blank"> The published article of the Combustion Toolbox is now available on ResearchGate!</a>',
