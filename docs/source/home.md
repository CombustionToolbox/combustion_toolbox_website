...
:link: https://combustion-toolbox-website.readthedocs.io/en/latest/documentation/databases.html
...
* *Cuadra, A., Huete, C., & Vera, M. (2023). Combustion Toolbox: A MATLAB-GUI based open-source tool for solving gaseous combustion problems. (v1.0.1). Zenodo. https://doi.org/10.5281/zenodo.5554911.*
